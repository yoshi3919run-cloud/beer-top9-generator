...
写真と名前を選んで、自分だけのビール履歴書を完成させましょう。
...
1番は「ビールを好きになったきっかけ」、4番は「一番大好きな不動のエースで4番」を選ぶと、ストーリーのある打線になります。
""")
...
st.info("""
📸 **写真がない時は？**
「昔飲んだあの1本の写真がない！」という時は、公式サイトの画像などを引用して思い出を補完してもOKです。
""")
...
st.write("1番から順番に、あなたの好きなビールを教えてください。")
