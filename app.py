...
**【打線の組み方ガイド】**
✅ **1番：『原点』**（沼落ちの1本） / **4番：『エース』**（至高の1本）
✅ **写真がなくても大丈夫！** 文字だけの入力でもカッコいいパネルになります。
✅ **9枚全部埋まらなくてもOK！** 1枚からでも作成可能です。

📸 **写真がない時は？**
公式の画像を**引用（スクショ等）**して思い出を補完するのもアリです。
""")
        ...
        with st.spinner('プレイボール！...'):
            ...
            for order in range(1, 10):
                ...
                if order in images:
                    ...
                    draw.rectangle([x + IMG_PADDING, y + IMG_PADDING, x + CELL_SIZE - IMG_PADDING, y + CELL_SIZE - IMG_PADDING], fill=panel_color, outline=(255,255,255,50))
                    ...
                    draw.text((x + 115, y + 155), f"{order}番", font=label_font, fill=(60, 120, 80))
            ...
            st.download_button(label="📥 チームを保存する", data=buf.getvalue(), file_name="beer_lineup.png", mime="image/png")
